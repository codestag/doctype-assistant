...
class stag_widget_recent_projects extends WP_Widget {
	public function __construct() {
		...
		$control_ops = array(
			'width'   => 300,
			'height'  => 350,
			'id_base' => 'stag_widget_recent_projects',
		);
	...
	<p>
		<label for="<?php echo $this->get_field_id( 'button_link' ); ?>"><?php _e( 'Portfolio Link:', 'doctype-assistant' ); ?></label>
		...
		<span class="description"><?php _e( 'Enter the portfolio page URL.', 'doctype-assistant' ); ?></span>
	</p>

	<p>
		<label for="<?php echo $this->get_field_id( 'button_text' ); ?>"><?php _e( 'Button Text:', 'doctype-assistant' ); ?></label>
		...
		<span class="description"><?php _e( 'Enter text for the portfolio button.', 'doctype-assistant' ); ?></span>
	</p>

	<p>
		<label for="<?php echo $this->get_field_id( 'post_count' ); ?>"><?php _e( 'Post Count:', 'doctype-assistant' ); ?></label>
		...
		<span class="description"><?php _e( 'Enter the number of recent portfolio items to display at homepage.', 'doctype-assistant' ); ?></span>
	</p>
